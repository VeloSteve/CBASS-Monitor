...
public class GridLabelRenderer {
    ...
    protected boolean adjustHorizontal(boolean changeBounds) {
        ...
        // human rounding to have nice numbers (1, 2, 5, ...)
        // Or 4?  2 to 5 is a big jump.
        if (isHumanRoundingX()) {
            // Project hardwires this false, but that truncates data!
        ...
        // JSR this forces the axis to start on a multiple of the step size, which is nice enough
        // when every stop size is a factor of 10.  If not (e.g. step size of 4) this is awkward.
        // For example, if the first point is 100 and the step size is 40, it's nicer to start from
        // 100 than from 80.
     ...
     * JSR: Jan 2022 add more steps for better use of screen space.
     *      options were 1, 2, 5
     *
